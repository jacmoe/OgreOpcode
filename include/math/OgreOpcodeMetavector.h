...
*/
#ifndef __OgreOpcodeMetavector_h__
#define __OgreOpcodeMetavector_h__
...
#if defined(_MSC_VER) && (_MSC_VER < 11300)
...
namespace OgreOpcode
{
	namespace math
	{
		...
		#ifndef OGREOPCODEMATH_METAVECTOR_ENABLE
		#define OGREOPCODEMATH_METAVECTOR_ENABLE
		#endif
...
#endif // !defined(_DEBUG) && !defined(__BORLANDC__) && !defined(__INTEL_COMPILER) && !defined(__GNUC__)
#endif // __OgreOpcodeMetavector_h__
